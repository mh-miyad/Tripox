  ...
  return (
    <aside className="lg:w-[18rem] h-screen bg-white dark:bg-slate-950 md:block">
      ...
      <div className="absolute bottom-12">
        <Link
          href={"/contact"}
          className="mx-3 flex  border w-full px-10 py-3 rounded-lg bg-blue-900/50 text-white hover:bg-blue-700 items-center gap-3  "
        >
          <span>
        ...
        <div className="mt-4 mb-2  bg-pink-500/20  dark:bg-pink-400/50 flex flex-col justify-center w-full mx-3 py-3 rounded-lg">
